...
const experiences = [
	{
		...
		type: "Internship",
		location: "Menzah 9, Ariana",
		description:
			"Worked on Development of GED options for student profiles project, Contributed to implementing document management features for student profiles, Applied SOLID principles to improve code structure, maintainability, and scalability, Collaborated with team members to resolve tasks from the project backlog and deliver functional features on time",
		skills: [
			"CodeIgniter 3",
			"MySQL",
			"PHP",
	...
	},
	{
		...
		type: "Part-time",
		location: "Menzah 5, Ariana",
		description:
			"Teach 2D game development to children using Unity and C#, Design hands-on lesson plans, exercises and mini-projects that teach programming, physics, and animation, Mentor students through project development, debugging, and final presentations, Foster creativity, problem-solving and teamwork through project-based learning.",
		skills: [
			"Unity",
			"C#",
		],
